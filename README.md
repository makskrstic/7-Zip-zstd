...
- by default, several history settings aren't stored by default (you can restore 7-Zip original behavior via tools->options->settings) - see #113 for more information about that
